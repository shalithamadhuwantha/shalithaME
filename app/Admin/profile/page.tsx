...
export default function ProfileEditor() {
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-yellow-500 font-mono text-lg">Loading your profile...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    ...
    <div className="min-h-screen bg-black text-yellow-500 font-mono">
      {/* Header */}
     <ProfileEditorHeader emoji="✒️" title="Profile Editor" description="Customize your profile sections" />
              ...
              <div className="bg-gray-900/50 border border-yellow-500/20 rounded-xl p-6 sm:p-8 backdrop-blur-sm transition-all duration-300 hover:border-yellow-500/40 hover:bg-gray-900/70">
                  ...
                  <div className="flex items-center space-x-2">
                    <button
                      onClick={() =>
                        setData({
                          ...data,
                          [key]: { ...data[key], visibility: !data[key].visibility },
                        })
                      }
                    ...
                    <span className={`text-sm font-medium ${
                      data[key].visibility ? 'text-yellow-500' : 'text-gray-400'
                    }`}>
                ...
                <div className="flex justify-end">
                  ...
                  >
                    ...
                    <span>Save {key.charAt(0).toUpperCase() + key.slice(1)}</span>
                  </button>
                </div>
              </div>
            </div>
