...
export default function SkillsDisplay() {
  ...
  useEffect(() => {
    if (data?.success && localSkills.length === 0) {
      const skillsProfile = data.profiles.find(
        (profile: any) => profile.name === "skills"
      );
  ...
  if (!skillsProfile) {
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          <p className="text-yellow-500/50 font-mono text-lg">
  ...
  const handleAddSkill = () => {
    ...
    setLocalSkills([
      ...localSkills,
      { name: newSkillName.trim(), level: levelNum },
    ]);
    setNewSkillName("");
    setNewSkillLevel("");
  };
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                  ...
                  <div className="mb-6">
                    {localSkills.length === 0 ? (
                      <div className="text-center py-12">
                        ...
                        <p className="text-yellow-500/50 text-lg">
                          No skills added yet
                        </p>
                        <p className="text-yellow-500/30 text-sm mt-2">
            ...
            <div className="mt-12 text-center">
              <p className="text-yellow-500/50 text-sm">
                Skills showcase your expertise and help others understand your
                capabilities
              </p>
            </div>
          </div>
